...
def webpage():
    ...
    <br><p class = "dotted">The elapsed time since the last button press is {elapsed_time} seconds</p></br>
    <h1>Control the LED on the Pico W with these buttons:</h1><br>
    <form accept-charset="utf-8" method="POST">
    <p><button class="button" name="LED" value="ON" type="submit">LED ON</button></a></p></form>
    <form accept-charset="utf-8" method="POST">
    <p><button class="button" name="LED" value="OFF" type="submit">LED OFF</button></a></p></form>
    <form accept-charset="utf-8" method="POST">
    <p><button class="button" name="Stopwatch" value="Watch" type="submit">STOPWATCH</a></button></form></p>
    </body>
    <script>
    // LED buttons handler
